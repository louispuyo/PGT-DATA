...
import pandas as pd
from SCRIPT import ROOTER
from SCRIPT2 import line


# import our model as an object class
model = line
print(model)
...
fast_parse(model, 'vta', '/Users/louispuyo/PGT-DATA/data-jupyter/temp/1120-2013.csv',
           number_of_workers=2)
